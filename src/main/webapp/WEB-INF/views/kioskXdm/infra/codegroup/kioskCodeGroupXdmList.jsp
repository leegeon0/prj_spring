...
<body>
	...
	<%@include file="kioskCodeGroupXdmListTop.jsp"%>
	                ...
	                <tbody>
						...
						<c:otherwise>
							...
							<tr>
								...
								<td><a href="kioskCodeGroupXdmForm?codegroupSeq=<c:out value="${list.codegroupSeq}"/>"><c:out value="${list.categoryName}"/></a></td>
								<td><c:out value="${list.codegroupSeq}"/>"><c:out value="${list.delNy}"/></td>
							</tr>
							</c:forEach>
						</c:otherwise>
						</c:choose>
  ...
  <%@include file="kioskCodeGroupXdmListBottom.jsp"%>
  ...
  $("#btn").on("click", function(){
		...
		$("form[name=formList]").attr("action", "/kioskCodeGroupXdmList").submit();
