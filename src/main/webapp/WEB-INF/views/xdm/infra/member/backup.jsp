               ...
               <form class="submitForm" name="form" method="post">
				   <table class="table">
	                ...
	                <tr>
		                ...
		                <td><input type="text" class="form-control" id="password" name="password"  required value="<c:out value="${item.password}"/>"></td>
		                <td><input type="text" class="form-control" id="name" name="name" required value="<c:out value="${item.name}"/>"></td>
		                <td><input type="text" class="form-control" id="memberAddress" name="memberAddress" required value="<c:out value="${item.memberAddress}"/>"></td>
		                <td><input type="text" class="form-control" id="memberTel" name="memberTel" required value="<c:out value="${item.memberTel}"/>"></td>
		                <td><input type="text" class="form-control" id="salesType" name="salesTypes" required value="<c:out value="${item.salesType}"/>"></td>
		                <td><input type="text" class="form-control" id="companyAddress" name="companyAddress" required value="<c:out value="${item.companyAddress}"/>"></td>
		                <td><input type="text" class="form-control" id="companyTel" name="companyTel" required value="<c:out value="${item.companyTel}"/>"></td>
